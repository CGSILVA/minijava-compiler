...
%{
  ...
  public String symbolToString(Symbol s) {
    switch (s.sym) {
      ...
      case sym.EQEQ: return "EQEQ";
      case sym.NOTEQ: return "NOTEQ";
      ...
      case sym.GTEQ: return "GTEQ";
      case sym.DOUBLE_TYPE: return "DOUBLE";
...
"System"{white}*"."{white}*"out"{white}*"."{white}*"println" 	{ return symbol(sym.SYSTEM_OUT_PRINTLN); }
